...
$result = mysql_query("SELECT * FROM ahli WHERE lulusbendahari='PENDING' && lulustolak='lulus'");
                                        ...
                                        while($row = mysql_fetch_array($result))
  {
                                            echo "<tbody>";
                                        echo "<tr>";
  echo "<td><a href=\"lulusbendahari.php?noahli=$row[noahli]\">LULUS</a>|<a href=\"gagalbendahari.php?noahli=$row[noahli]\">GAGAL</a>";
