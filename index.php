           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-edit fa-3x"></i> Ahli Bridget Bakti Malaysia<span class="fa arrow"></span></a>
...
$result4 = mysql_query("SELECT * FROM pegawai") or die(mysql_error());
