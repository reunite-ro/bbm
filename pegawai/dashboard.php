...
$result = mysql_query("SELECT * FROM ahli WHERE pegawaiid='$login_session'") or die(mysql_error());
...
$result2 = mysql_query("SELECT * FROM ahli WHERE lulustolak='PENDING' && pegawaiid='$login_session'") or die(mysql_error());
...
$result3 = mysql_query("SELECT * FROM kegiatan WHERE pegawaiid='$login_session'") or die(mysql_error());
