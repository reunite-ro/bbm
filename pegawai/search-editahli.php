...
$result = mysql_query("SELECT * FROM ahli WHERE  pegawaiid='$login_session' && (`noahli` LIKE '%".$query."%') OR (`nama` LIKE '%".$query."%') OR (`ic` LIKE '%".$query."%') OR (`namaunit` LIKE '%".$query."%') OR (`facebook` LIKE '%".$query."%') ");
